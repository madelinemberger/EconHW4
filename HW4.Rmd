...
MCC_plot <- ggplot (abatement, aes(x = Abatement, y = MC_C)) +
  geom_line()

MCC_plot

degree_1 <- lm(abatement$MC_C ~ abatement$Abatement)
...
MCD_plot <- ggplot (abatement, aes(x = Abatement, y = MC_D)) +
  geom_line()

MCD_plot

degree_1 <- lm(abatement$MC_D ~ abatement$Abatement)
