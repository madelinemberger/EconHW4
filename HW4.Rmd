...
deno = A_coeff * B_coeff + A_coeff * C_coeff + B_coeff * C_coeff
agg_y_int = (A_y_int*B_coeff*C_coeff/deno) + (B_y_int*A_coeff*C_coeff/deno) + (C_y_int*B_coeff*A_coeff/deno)
agg_coeff = (A_coeff*B_coeff*C_coeff/deno)
